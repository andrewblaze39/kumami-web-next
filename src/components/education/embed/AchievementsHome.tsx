...
/**
 * AchievementsHome — Andrew's original /education/achievements page, extracted
 * verbatim as a component for the world shell's Education → Achievements
 * subtab. Restored from git history (da01e8a^).
 */
