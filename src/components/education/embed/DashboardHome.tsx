...
/**
 * DashboardHome — Andrew's original /education/dashboard page, extracted
 * verbatim as a component for the world shell's Education → Dashboard subtab.
 * Restored from git history (da01e8a^).
 */
