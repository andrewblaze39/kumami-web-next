...
/**
 * DashboardTab — Learner Dashboard content, rendered as the "Dashboard"
 * subtab of /world/education (extracted from the old /world/dashboard page,
  ...
  if (inProgress.length === 0) {
    return (
      <div className="w-dash-empty">
        ...
        <Link href="/world/education?tab=courses" className="w-btn w-btn-ghost w-btn-sm">
          Browse courses
        </Link>
      </div>
    );
