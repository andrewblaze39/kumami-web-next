...
/**
 * MarketCapTab — Kumami World port of the CRA Market Cap Tool
 * (kumami-web/src/pages/Pro/MarketCapTool.js).
 *
 * "What if coin A had coin B's market cap?" calculator. Fetches CoinGecko
 * coins/markets (per_page=250, CRA parity) through the local
 * /api/coingecko/markets proxy with a manual refresh button. Restyled with
 * Kumami World tokens (turquoise accent, gold/purple/bull/bear palette) —
 * functionality identical to CRA.
 */
  ...
  return (
    <div ref={ref} style={{ position: 'relative', flex: 1, minWidth: 0 }}>
      <div style={{
        ...
        color: 'rgba(0,194,199,0.6)', marginBottom: 8,
      }}>{label}</div>
      ...
      <button
        ...
        style={{
          ...
          background: open ? 'rgba(0,194,199,0.08)' : 'rgba(255,255,255,0.04)',
          border: `1.5px solid ${open ? '#00c2c7' : 'rgba(0,194,199,0.15)'}`,
          ...
          <>
            ...
            <div style={{ textAlign: 'right', flexShrink: 0 }}>
              ...
              <div style={{
                ...
                color: selected.price_change_percentage_24h >= 0 ? '#46e3a0' : '#ff6b81',
              }}>
      ...
      {open && (
        <div style={{
          ...
          border: '1.5px solid rgba(0,194,199,0.2)',
            ...
            {filtered.length === 0 ? (
              ...
              <button
                ...
                style={{
                  ...
                  background: selected?.id === coin.id ? 'rgba(0,194,199,0.1)' : 'transparent',
              ...
              >
                ...
                <div style={{ textAlign: 'right', flexShrink: 0 }}>
                  ...
                  <div style={{
                    ...
                    color: coin.price_change_percentage_24h >= 0 ? '#46e3a0' : '#ff6b81',
                  }}>
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        color: highlightB ? '#00c2c7' : 'rgba(255,255,255,0.7)',
      }}>{valueB ?? '—'}</div>
    </div>
  )
}
...
export default function MarketCapTab() {
  ...
  const fetchCoins = async (isRefresh = false) => {
    try {
      ...
      for (let attempt = 0; attempt < 3; attempt++) {
        ...
        res = await fetch('/api/coingecko/markets?vs_currency=usd&order=market_cap_desc&per_page=250&page=1')
  ...
  const gainColor = '#46e3a0'
  const lossColor = '#ff6b81'
    ...
    return (
      <div style={{ padding: '48px 24px', textAlign: 'center', maxWidth: 500, margin: '0 auto' }}>
        ...
        <button onClick={() => fetchCoins()} style={{
          ...
          background: '#00c2c7', color: 'var(--on-accent)',
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 4 }}>
            <BarChart3 size={18} style={{ color: '#00c2c7' }}/>
            <span style={{
              fontSize: 11, fontWeight: 800, letterSpacing: '0.14em',
              textTransform: 'uppercase', color: '#00c2c7',
          ...
          <h2 style={{
            ...
            What if <span style={{ color: '#00c2c7' }}>{coinA?.name ?? '…'}</span> had{' '}
            <span style={{ color: '#b9a4ff' }}>{coinB?.name ?? '…'}</span>&apos;s market cap?
          </h2>
        </div>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, flexShrink: 0 }}>
          ...
          <button
            ...
            style={{
              ...
              color: '#00c2c7', cursor: refreshing ? 'not-allowed' : 'pointer',
      ...
      <div style={{
        ...
        <button
          ...
          style={{
            ...
            border: '1.5px solid rgba(0,194,199,0.25)',
            color: '#00c2c7', cursor: 'pointer',
            display: 'flex', alignItems: 'center', justifyContent: 'center',
            transition: 'all .2s ease', alignSelf: 'flex-end',
          }}
          onMouseEnter={e => {
            e.currentTarget.style.background = 'rgba(0,194,199,0.2)'
            e.currentTarget.style.transform = 'rotate(180deg)'
          }}
          onMouseLeave={e => {
            e.currentTarget.style.background = 'rgba(0,194,199,0.1)'
      ...
      {calc && coinA && coinB ? (
        <div style={{
          ...
          background: 'linear-gradient(135deg, rgba(0,194,199,0.07) 0%, rgba(185,164,255,0.05) 100%)',
          border: '1.5px solid rgba(0,194,199,0.18)',
          marginBottom: 20,
        }}>
          {/* Top bar */}
          <div style={{
            ...
            <span style={{ fontSize: 12, fontWeight: 700, color: 'rgba(255,255,255,0.6)' }}>
              ...
              <strong style={{ color: '#b9a4ff' }}>{coinB.name}</strong>&apos;s market cap of{' '}
              <strong style={{ color: '#b9a4ff' }}>{fmt.cap(coinB.market_cap)}</strong>
            </span>
          </div>
          ...
          <div style={{
            ...
            <div>
              <div style={{
                ...
                textTransform: 'uppercase', color: 'rgba(0,194,199,0.6)', marginBottom: 6,
              }}>Target price</div>
              <div style={{
                fontSize: 52, fontWeight: 900, letterSpacing: '-0.04em', lineHeight: 1,
                background: 'linear-gradient(90deg, #00c2c7, #b9a4ff)',
            ...
            <div style={{ textAlign: 'right' }}>
              ...
              <div style={{
                ...
                background: calc.isGain ? 'rgba(70,227,160,0.12)' : 'rgba(255,107,129,0.12)',
                border: `1.5px solid ${calc.isGain ? 'rgba(70,227,160,0.3)' : 'rgba(255,107,129,0.3)'}`,
                marginBottom: 10,
              }}>
                {calc.isGain
        ...
        <div style={{
          ...
          border: '1.5px solid rgba(0,194,199,0.1)',
          marginBottom: 20,
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src={coinA.image} alt={coinA.name} style={{ width: 22, height: 22, borderRadius: '50%' }}/>
              <span style={{ fontSize: 13, fontWeight: 800, color: '#00c2c7' }}>{coinA.symbol.toUpperCase()}</span>
            </div>
            <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, justifyContent: 'flex-end' }}>
              <span style={{ fontSize: 13, fontWeight: 800, color: '#b9a4ff' }}>{coinB.symbol.toUpperCase()}</span>
              {/* eslint-disable-next-line @next/next/no-img-element */}
      ...
      {calc && coinA && coinB && (
        <div style={{
          ...
          border: '1px solid rgba(185,164,255,0.15)',
          ...
          of <strong style={{ color: '#00c2c7' }}>{fmt.cap(coinA.market_cap)}</strong>.{' '}
          To match <strong style={{ color: '#b9a4ff' }}>{coinB.name}</strong>&apos;s{' '}
          <strong style={{ color: '#b9a4ff' }}>{fmt.cap(coinB.market_cap)}</strong>, it would need to{' '}
          {calc.isGain
            ? <><strong style={{ color: '#46e3a0' }}>grow {fmt.mult(calc.multiplier)}</strong> from here.</>
            : <><strong style={{ color: '#ff6b81' }}>shrink by {Math.abs(100 - (calc.multiplier * 100)).toFixed(1)}%</strong>.</>
          }
        </div>
      )}
