...
export default function AddCryptoModal({
  ...
  const renderCoinList = () => (
    <div>
      {isSearching && (
        <div className="text-center py-4 text-sm" style={{ color: 'rgba(0,194,199,0.7)' }}>
          Searching...
        </div>
      )}
            ...
            <div
              ...
              className={cn(
                ...
                selectedCoin?.id === coin.id
                  ? 'bg-[rgba(0,194,199,0.15)]'
                  : 'hover:bg-[rgba(0,194,199,0.08)]',
                isFetchingPrice && 'opacity-60 cursor-wait'
              )}
              style={
                selectedCoin?.id === coin.id ? { color: '#00c2c7' } : {}
              }
            >
              ...
              <div className="text-right">
                {isFetchingPrice ? (
                  <div className="text-xs" style={{ color: 'rgba(0,194,199,0.7)' }}>Getting price...</div>
                  ...
                  <div className="text-xs" style={{ color: 'rgba(0,194,199,0.5)' }}>...</div>
                ) : (
    ...
    <>
      {recent.length > 0 && (
        <div className="flex items-center gap-2 px-2.5 py-2 rounded-[10px]"
          style={{ background: 'rgba(0,194,199,0.08)', border: '1px solid rgba(0,194,199,0.18)' }}>
          <span className="text-[10px] font-black tracking-[0.04em]" style={{ color: '#00c2c7', flexShrink: 0 }}>
            ✓ JUST ADDED
          </span>
      ...
      <div className="flex flex-col">
        ...
        <div
          ...
          style={{
            ...
            boxShadow: pulse ? '0 0 0 2px #00c2c7, 0 0 40px rgba(0,194,199,0.4)' : 'none',
          }}
        >
          {selectedCoin ? (
        ...
        <div className="flex flex-col">
          ...
          <div className="flex flex-col gap-2">
            ...
            >
              <div className="flex items-center gap-3 justify-between py-2 px-3">
                <div className="flex items-center gap-2">
                  <div className="flex items-center justify-center w-8 h-8 rounded-full bg-[#00c2c7]">
  ...
  const renderActionButtons = () => (
    <div className="mt-1">
      <p className="text-[11px] mb-2" style={{ color: 'rgba(255,255,255,0.5)' }}>
        {recent.length > 0
          ? <><span style={{ color: '#00c2c7', fontWeight: 800 }}>{recent.length}</span> added this session</>
          : 'Add will not close the modal — keep going.'}
      </p>
      <div className="flex gap-3">
        <button
          onClick={handleClose}
          className="flex-1 rounded-xl transition-colors py-2 px-5 font-semibold text-[#00c2c7] border border-[#00c2c7]/30 hover:bg-[#00c2c7]/10"
        ...
        <button
          ...
          className="flex-1 rounded-xl transition-colors disabled:opacity-50 disabled:cursor-not-allowed py-2 px-5 font-semibold bg-[#00c2c7] text-[#00272a]"
        >
          Add Asset
        </button>
      </div>
    ...
    >
      <div
        ...
        style={{
          ...
          backgroundImage:
            'radial-gradient(circle, rgba(0,194,199,0.06) 1px, transparent 1px)',
      ...
      >
        <button
          onClick={handleClose}
          className="absolute top-4 right-4 flex items-center justify-center w-8 h-8 rounded-lg transition-colors hover:bg-[#00c2c7]/20"
          style={{ color: '#00c2c7', background: 'rgba(0,194,199,0.08)' }}
            ...
            {mobileStep === 'select' ? (
              <div className="flex flex-col gap-3">
                    ...
                    {CATEGORY_CHIPS.map(chip => {
                      ...
                      return (
                        <button
                          ...
                          style={{
                            background: isActive ? 'rgba(0,194,199,0.14)' : 'rgba(255,255,255,0.04)',
                            border: `1px solid ${isActive ? '#00c2c7' : 'rgba(255,255,255,0.12)'}`,
                            color: isActive ? '#00c2c7' : 'rgba(255,255,255,0.55)',
                            cursor: 'pointer',
                          }}
                        >
                          {chip.label}
                ...
                <div className="relative">
                  <Search className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-[#00c2c7]" />
                  <input
                    type="text"
              ...
              <div className="flex flex-col gap-3">
                <button
                  ...
                  className="self-start flex items-center gap-1 text-sm font-semibold transition-opacity hover:opacity-70 text-[#00c2c7] bg-transparent border-none p-0"
                >
          ...
          >
            <div className="flex-1 flex flex-col gap-3 basis-1/2">
              ...
              <div
                ...
                style={{ border: '1px solid rgba(0,194,199,0.15)' }}
              >
                {isLoading && !isSearchMode ? (
                  <div className="text-white text-center py-8">
                    Loading cryptocurrencies...
