      ...
      >
        ...
        <div className="flex flex-col gap-4">
          ...
          >
            <div className="flex items-center gap-2">
              {coin.logo ? (
                ...
                <div className="w-8 h-8 rounded-full bg-[#00c2c7] flex items-center justify-center">
                  <span className="text-[#00272a] font-bold">{coin.name.substring(0, 1)}</span>
                </div>
              )}
            </div>
            ...
            <div className="text-right">
              ...
              <div className="flex items-center mt-1">
                <button
                  ...
                  className="flex items-center text-xs transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-[#00c2c7]"
                >
                  <RefreshCw
                    size={12}
                ...
                <div className="flex items-center gap-3 justify-between py-2 px-3">
                  <div className="flex items-center gap-2">
                    {coin.logo ? (
                      ...
                      <div className="w-8 h-8 rounded-full bg-[#00c2c7] flex items-center justify-center">
                        <span className="text-[#00272a] font-bold">
          ...
          <div className="flex gap-3 mt-4">
            <button
              onClick={handleClose}
              className="flex-1 rounded-xl transition-colors py-2.5 px-4 font-semibold text-[#00c2c7] border border-[#00c2c7]/30 hover:bg-[#00c2c7]/10"
            ...
            <button
              ...
              className="flex-1 rounded-xl transition-colors disabled:opacity-50 disabled:cursor-not-allowed py-2.5 px-4 font-semibold bg-[#00c2c7] text-[#00272a]"
            >
              Save Changes
            </button>
          </div>
