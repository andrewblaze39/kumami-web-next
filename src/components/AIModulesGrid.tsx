...
export default function AIModulesGrid() {
          ...
          .map((doc) => {
            ...
            return {
              ...
              thumbnail:
                ...
                'https://via.placeholder.com/300x200?text=AI%20Module',
  ...
  const handleModuleClick = (moduleId: string) => {
    router.push(`/ai-labs/module/${moduleId}`)
  }
      ...
      <div className="max-w-[1400px] mx-auto relative z-10">
        ...
        {loading ? (
          <div className="flex justify-center items-center py-24">
            <Loader className="animate-spin text-[#96EDD6]" size={40} />
          </div>
        ) : (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mt-8">
            {filteredModules.length === 0 ? (
              <div className="col-span-full text-center py-12 text-gray-400 text-lg">
                No AI modules found matching your criteria.
              </div>
            ) : (
              filteredModules.map((module) => (
                ...
                >
                  <div className="w-full aspect-video overflow-hidden bg-[#2a2a2a]">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <h3 className="w-full text-base font-semibold text-white m-0 h-12 flex items-center overflow-hidden line-clamp-2">
                      {module.title}
                    </h3>
                  </div>
                </div>
